...
title: 'CIS 197: JavaScript (Fall 2021)'
---
...
<InfoMessage showIcon>
  This course meets Mondays from 8:30am to 10:00am @ Towne 315.
</InfoMessage>
...
- MV\* frameworks (ReactJS, GatsbyJS, NextJS)
- Query languages and databases (GraphQL, MongoDB, MySQL)
...
We use CampusWire instead of Piazza for asking questions and sharing updates about the course. You can join [here](https://campuswire.com/c/GAF6BB875/feed).

Homeworks are submitted to Gradescope with course code 86Z4Z8. You can submit an unlimited number of times. The majority of homeworks have automated test cases which run immedaitely after you submit, allowing you to check your work.
