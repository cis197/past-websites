...
- Convenience tools: controlling room lights, a better when2meet
- Social: simplified chat app, social network, real-time Spotify streaming within a group of users
- Simplified card games (e.g. poker, NBA)

<!-- ### Cool || Useful Frameworks/Libraries

- Passportjs (for managing users and logins, ‘Login with Facebook’, ‘Login with Google’)
- NextJS (a more advanced React framework)
...
Proposal Submitted: **Wednesday, March 30**

TA Approval: **Sunday, April 3**

You’ll need to writeup and submit a final project proposal on GradeScope by Wednesday, March 30. The project proposal should consist of the following items
...
#### Milestone 1: Thursday, April 11th
...
#### Milestone 2: Thursday, April 18th
...
You have to present your web/mobile app to the instructor on either Wednesday 4/20 or Thursday 4/21 during class time.
...
**Everyone has to show up on Thursday 4/21. Attendance will be taken.**
